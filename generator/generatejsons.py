...
plants = [("artichoke", "artichokes"), ("asparagus", "asparagus"), ("barley", "barley"), ("basil", "basil"), ("bellpepper", "bellpeppers"), ("blackbean", "blackbeans"), ("blackberry", "blackberries"), ('blueberry', 'blueberries'), ('broccoli', 'broccoli'), ('cabbage', 'cabbage'), ('cantaloupe', 'cantaloupes'), ('cauliflower', 'cauliflower'), ('celery', 'celery'), ('chile_pepper', 'chile_peppers'), ('coffee_beans', 'coffee_beans'), ('corn', 'corn'), ('cranberry', 'cranberries'), ('cucumber', 'cucumbers'), ('currant', 'currants'), ('eggplant', 'eggplants'), ('elderberry', 'elderberries'), ('garlic', 'garlic'), ('ginger', 'ginger'), ('grape', 'grapes'), ('greenbean', 'greenbeans'), ('greenonion', 'greenonions'), ('honeydew', 'honeydew'), ('hops', 'hops'), ('kale', 'kale'), ('kiwi', 'kiwis'), ('leek', 'leek'), ('lettuce', 'lettuce'), ('mustard', 'mustard'), ('oat', 'oat'), ('olive', 'olives'), ('onion', 'onions'), ('peanut', 'peanuts'), ('pepper', 'pepper'), ('pineapple', 'pineapples'), ('radish', 'radishes'), ('raspberry', 'raspberries'), ('rhubarb', 'rhubarb'), ('rice', 'rice'), ('rutabaga', 'rutabaga'), ('saguaro', 'saguaro'), ('soybean', 'soybean'), ('spinach', 'spinach'), ('squash', 'squash'), ('strawberry', 'strawberry'), ('sweetpotato', 'sweetpotato'), ('tea_leaves', 'tea_leaves'), ('tomatillo', 'tomatillo'), ('tomato', 'tomato'), ('turmeric', 'turmeric'), ('turnip', 'turnip'), ('vanilla', 'vanilla'), ('yam', 'yam'), ('zucchini', 'zucchini')]
